...
public class main
{
    public static void main(String[] args) {
        ...
        gifts[0] = new chocolate("Bournville",10);
        gifts[1] = new sweets("BesanLadoo",20);
        gifts[2] = new chocolate("Temptations",5);
        gifts[3] = new sweets("Barfi",2);
        gifts[4] = new chocolate("DairyMilk",15);
